-----------
Expanding base 'CN=AllValidatedWrites,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol'...
Getting 1 entries:
Dn: CN=AllValidatedWrites,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol
cn: AllValidatedWrites; 
distinguishedName: CN=AllValidatedWrites,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol; 
...
name: AllValidatedWrites; 
objectCategory: CN=Group,CN=Schema,CN=Configuration,DC=corp1,DC=lab,DC=home-labs,DC=lol; 
objectClass (2): top; group; 
objectGUID: 64db8b88-e79c-4221-9289-a09437d4f089; 
objectSid: S-1-5-21-1974516972-3116780949-2584384717-1278; 
sAMAccountName: AllValidatedWrites; 
...
SACL not present
Security for "CN=AllValidatedWrites,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol"
-----------
***Calling Security...
-----------
