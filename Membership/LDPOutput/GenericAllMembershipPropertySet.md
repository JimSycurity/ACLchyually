-----------
Expanding base 'CN=GenericAllMembershipPropertySet,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol'...
Getting 1 entries:
Dn: CN=GenericAllMembershipPropertySet,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol
cn: GenericAllMembershipPropertySet; 
distinguishedName: CN=GenericAllMembershipPropertySet,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol; 
...
name: GenericAllMembershipPropertySet; 
objectCategory: CN=Group,CN=Schema,CN=Configuration,DC=corp1,DC=lab,DC=home-labs,DC=lol; 
objectClass (2): top; group; 
objectGUID: 57d58bb3-e4dc-4fbb-8bb3-f078d7f9e618; 
objectSid: S-1-5-21-1974516972-3116780949-2584384717-1272; 
sAMAccountName: GenericAllMembershipPropertySet; 
...
SACL not present
Security for "CN=GenericAllMembershipPropertySet,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol"
-----------
***Calling Security...
-----------
