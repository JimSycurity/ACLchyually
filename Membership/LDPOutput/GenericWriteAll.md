-----------
Expanding base 'CN=GenericWriteAll,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol'...
Getting 1 entries:
Dn: CN=GenericWriteAll,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol
cn: GenericWriteAll; 
distinguishedName: CN=GenericWriteAll,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol; 
...
name: GenericWriteAll; 
objectCategory: CN=Group,CN=Schema,CN=Configuration,DC=corp1,DC=lab,DC=home-labs,DC=lol; 
objectClass (2): top; group; 
objectGUID: 4fd88aae-752b-44a8-9ece-4c1663113484; 
objectSid: S-1-5-21-1974516972-3116780949-2584384717-1270; 
sAMAccountName: GenericWriteAll; 
...
SACL not present
Security for "CN=GenericWriteAll,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol"
-----------
***Calling Security...
-----------
