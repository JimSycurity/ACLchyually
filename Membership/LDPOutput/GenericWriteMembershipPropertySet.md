-----------
Expanding base 'CN=GenericWriteMembershipPropertySet,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol'...
Getting 1 entries:
Dn: CN=GenericWriteMembershipPropertySet,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol
cn: GenericWriteMembershipPropertySet; 
distinguishedName: CN=GenericWriteMembershipPropertySet,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol; 
...
name: GenericWriteMembershipPropertySet; 
objectCategory: CN=Group,CN=Schema,CN=Configuration,DC=corp1,DC=lab,DC=home-labs,DC=lol; 
objectClass (2): top; group; 
objectGUID: 23cdfd1f-d139-49cd-b41d-78b70761df64; 
objectSid: S-1-5-21-1974516972-3116780949-2584384717-1273; 
sAMAccountName: GenericWriteMembershipPropertySet; 
...
SACL not present
Security for "CN=GenericWriteMembershipPropertySet,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol"
-----------
***Calling Security...
-----------
