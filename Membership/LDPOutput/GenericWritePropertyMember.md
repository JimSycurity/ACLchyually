-----------
Expanding base 'CN=GenericWritePropertyMember,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol'...
Getting 1 entries:
Dn: CN=GenericWritePropertyMember,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol
cn: GenericWritePropertyMember; 
distinguishedName: CN=GenericWritePropertyMember,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol; 
...
name: GenericWritePropertyMember; 
objectCategory: CN=Group,CN=Schema,CN=Configuration,DC=corp1,DC=lab,DC=home-labs,DC=lol; 
objectClass (2): top; group; 
objectGUID: af38deb1-7087-45b9-ab11-dc3361fe8adf; 
objectSid: S-1-5-21-1974516972-3116780949-2584384717-1276; 
sAMAccountName: GenericWritePropertyMember; 
...
SACL not present
Security for "CN=GenericWritePropertyMember,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol"
-----------
***Calling Security...
-----------
