-----------
Expanding base 'CN=SelfMembershipPropertySet,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol'...
Getting 1 entries:
Dn: CN=SelfMembershipPropertySet,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol
cn: SelfMembershipPropertySet; 
distinguishedName: CN=SelfMembershipPropertySet,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol; 
...
name: SelfMembershipPropertySet; 
objectCategory: CN=Group,CN=Schema,CN=Configuration,DC=corp1,DC=lab,DC=home-labs,DC=lol; 
objectClass (2): top; group; 
objectGUID: 1e41c869-2b21-4713-ac97-89e47accadce; 
objectSid: S-1-5-21-1974516972-3116780949-2584384717-1280; 
sAMAccountName: SelfMembershipPropertySet; 
...
SACL not present
Security for "CN=SelfMembershipPropertySet,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol"
-----------
***Calling Security...
-----------
