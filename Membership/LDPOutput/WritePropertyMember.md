-----------
Expanding base 'CN=WritePropertyMember,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol'...
Getting 1 entries:
Dn: CN=WritePropertyMember,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol
cn: WritePropertyMember; 
distinguishedName: CN=WritePropertyMember,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol; 
...
name: WritePropertyMember; 
objectCategory: CN=Group,CN=Schema,CN=Configuration,DC=corp1,DC=lab,DC=home-labs,DC=lol; 
objectClass (2): top; group; 
objectGUID: 2ba73166-1e52-4617-9e52-74274a326480; 
objectSid: S-1-5-21-1974516972-3116780949-2584384717-1277; 
sAMAccountName: WritePropertyMember; 
...
SACL not present
Security for "CN=WritePropertyMember,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol"
-----------
***Calling Security...
-----------
