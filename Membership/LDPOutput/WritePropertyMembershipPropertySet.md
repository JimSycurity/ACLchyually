-----------
Expanding base 'CN=WritePropertyMembershipPropertySet,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol'...
Getting 1 entries:
Dn: CN=WritePropertyMembershipPropertySet,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol
cn: WritePropertyMembershipPropertySet; 
distinguishedName: CN=WritePropertyMembershipPropertySet,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol; 
...
name: WritePropertyMembershipPropertySet; 
objectCategory: CN=Group,CN=Schema,CN=Configuration,DC=corp1,DC=lab,DC=home-labs,DC=lol; 
objectClass (2): top; group; 
objectGUID: c168df30-e680-4a9b-b80a-97f0c2015656; 
objectSid: S-1-5-21-1974516972-3116780949-2584384717-1274; 
sAMAccountName: WritePropertyMembershipPropertySet; 
...
SACL not present
Security for "CN=WritePropertyMembershipPropertySet,OU=Membership,OU=Misconfigs,DC=corp1,DC=lab,DC=home-labs,DC=lol"
-----------
***Calling Security...
-----------
